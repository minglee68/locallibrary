...
exports.book_list = function(req, res, next){
	// find all Book objects and return title and author field only
	// use author (_id) to get matching Author's details
...
exports.book_delete_post = function(req, res, next){
	async.parallel({
		...
		if (results.books_bookinstances.length > 0){
			...
			// Book has no book instances, so delete object and reidrect to the list of books.
...
exports.book_update_post = [
	...
	(req, res, next) => {
		if(!(req.body.genre instanceof Array)){
			if(typeof req.body.genre==='undeifined')
				req.body.genre=[];
			else
				req.body.genre=new Array(req.body.genre);
		}
